...
func printUsage() {
	...
	fmt.Println("  --not-found-off        - Disable the generated 404.html (a page slugged")
	fmt.Println("                           \"404\" still wins; without either, static hosts")
	fmt.Println("                           answer unknown paths with index.html and a 200)")
