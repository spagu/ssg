...
class Ssg < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/spagu/ssg/releases/download/v1.8.45/ssg-darwin-arm64.tar.gz"
      sha256 "339168be6005853362be1de8c9a38940186b6da17e9a67a3b161f92130e26c12"
    end
    on_intel do
      url "https://github.com/spagu/ssg/releases/download/v1.8.45/ssg-darwin-amd64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/spagu/ssg/releases/download/v1.8.45/ssg-linux-arm64.tar.gz"
      sha256 "b0ff8632d19b4d55990f3fd94f089a89690c18a1e6bd9d6cfdd8123afa89cffd"
    end
    on_intel do
      url "https://github.com/spagu/ssg/releases/download/v1.8.45/ssg-linux-amd64.tar.gz"
